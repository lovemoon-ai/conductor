          ...
          >
            <div className="min-w-0">
              <div className="flex items-center gap-2 text-sm font-medium text-ink">
                ...
                {isCurrent ? (
                  <span className="rounded bg-[var(--accent)]/15 px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-[var(--accent)]">
                    current
                  </span>
                ) : null}
              </div>
              {acct.planType ? (
                <div className="truncate text-xs text-muted">{acct.planType}</div>
              ) : null}
            </div>
            <button
              type="button"
