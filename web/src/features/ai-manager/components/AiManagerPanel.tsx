...
import type { ExternalQuota } from '../types';
...
function externalQuotaBackends(backends: string[]): string[] {
  return [...new Set(
    backends
...
export function AiManagerPanel({ initialAgentHost }: AiManagerPanelProps = {}) {
  ...
  const externalBackends = externalQuotaBackends(supportedBackends);
