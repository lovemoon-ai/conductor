...
To use a Conductor-managed Node.js in `~/.conductor` instead of the npm already on your system:

```bash
curl -fsSL https://conductor-ai.top/install.sh | CONDUCTOR_SELF_NPM=1 bash
```
