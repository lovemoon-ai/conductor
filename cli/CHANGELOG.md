...
- 9858ad5: Fix Update daemon deleting the running install when the upgrade failed. Any
  ...
  retry fails.
- Updated dependencies [0859251]
- Updated dependencies [c1b66d1]
- Updated dependencies [f6dbd6b]
  - @love-moon/ai-sdk@0.13.3
  - @love-moon/conductor-sdk@0.13.3
...
- b749180: Add `conductor remote cp` for copying a single file to or from another daemon's
...
- @love-moon/conductor-sdk@0.12.0
- @love-moon/ai-sdk@0.12.0

## 0.11.2

### Patch Changes

- 938efe7: Fix "New task from this" when the successor runs on a different daemon.
  ...
  - @love-moon/conductor-sdk@0.11.2
  - @love-moon/ai-sdk@0.11.2

## 0.11.1

### Patch Changes

- cd5e428: Add a built-in "Update daemon" action to the web settings Danger zone.
...
- 8ad51f3: Adopt the tmux-detached Fire processes a previous daemon left running, instead
  ...
  - @love-moon/conductor-sdk@0.11.1
  - @love-moon/ai-sdk@0.11.1
